...
[x, flag, relres, iter, resvec1] = gmres(A, b, restart, tol, maxit, P, [], x0);
hold on
semilogy(resvec1)
hold off
...
[x, flag, relres, iter, resvec2] = gmres(A, b, restart, tol, maxit, P, [], x0);
hold on
semilogy(resvec2)
hold off
...
[x, flag, relres, iter, resvec3] = gmres(A, b, restart, tol, maxit, P, [], x0);
hold on
semilogy(resvec3)
hold off
...
[x, flag, relres, iter, resvec4] = gmres(A, b, restart, tol, maxit, P, [], x0);
hold on
semilogy(resvec4)
hold off
...
[x, flag, relres, iter, resvec5] = gmres(A, b, restart, tol, maxit, P, [], x0);
hold on
semilogy(resvec5)
hold off
...
[x, flag, relres, iter, resvec6] = gmres(A, b, restart, tol, maxit, P, [], x0);
hold on
semilogy(resvec6)
hold off
...
[x, flag, relres, iter, resvec7] = gmres(A, b, restart, tol, maxit, P, [], x0);
hold on
semilogy(resvec7)
legend('GMRES','gamma=0.7','gamma=0.9','gamma=1','gamma=1.2','gamma=1.4','gamma=1.6','gamma=1.7')
